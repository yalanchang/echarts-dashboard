declare global {
  ...
  const fail: typeof import('../../server/utils/response').fail
  ...
  const ok: typeof import('../../server/utils/response').ok
  const paginated: typeof import('../../server/utils/response').paginated
...
declare global {
  ...
  // @ts-ignore
  export type { JwtPayload } from '../../server/utils/auth'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/zhangyalan/echart/echarts-dashboard-1/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/zhangyalan/echart/echarts-dashboard-1/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { signToken, verifyToken, getAuthUser, requireAuth, requireAdmin } from '/Users/zhangyalan/echart/echarts-dashboard-1/server/utils/auth';
export { ok, paginated, fail } from '/Users/zhangyalan/echart/echarts-dashboard-1/server/utils/response';